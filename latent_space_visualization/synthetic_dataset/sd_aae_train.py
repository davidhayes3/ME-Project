...
from sd_models import encoder_model, generator_model, aae_discriminator_model
from common_models.common_models import aae_model
from functions.auxiliary_funcs import save_models
from functions.visualization_funcs import save_reconstructions, save_latent_vis, plot_gan_batch_loss, plot_gan_epoch_loss, \
...
latent_dim = 2
num_classes = 16
image_path = 'Images/sd_aae'
model_path = 'Models/sd_aae'
