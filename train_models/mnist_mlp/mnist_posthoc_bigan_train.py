...
from functions.visualization_funcs import plot_gan_epoch_loss, plot_gan_batch_loss, save_reconstructions, save_imgs, \
    plot_discriminator_acc
from mnist_mlp_models import encoder_model, generator_model, bigan_discriminator_model
...
latent_dim = 100
num_classes = 10
image_path = 'Images/mnist_posthoc_bigan'
model_path = 'Models/mnist_posthoc_bigan'
...
for epoch in range(epochs):
    ...
    if epoch % epoch_save_interval == 0:
        # Generate images from prior smaple
