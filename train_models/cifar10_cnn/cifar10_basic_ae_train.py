...
from cifar10_models import encoder_model, deterministic_encoder_model, generator_model
...
latent_dim = 64
num_classes = 10
image_path = 'Images/cifar10_basic_ae'
model_path = 'Models/cifar10_basic_ae'
